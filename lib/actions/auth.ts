...
export async function registerUser(prevState: unknown, formdata: FormData) {
  return rpcContext.run(
    ...
    async () => {
      ...
      console.log(`[${context?.requestId}] registerUser started`);
      ...
      try {
        ...
        console.log(`[${context?.requestId}] User created: ${user.email}`);
...
export async function loginUser(prevState: unknown, formdata: FormData) {
  return rpcContext.run(
    ...
    async () => {
      const context = getServerActionContext();
      console.log(`[${context?.requestId}] loginUser started`);
      ...
      try {
        ...
        console.log(
          `[${context?.requestId}] User login successful: ${user.email}`,
        );
...
export async function signOutUser() {
  return rpcContext.run(
    ...
    async () => {
      const context = getServerActionContext();
      console.log(`[${context?.requestId}] signOutUser started`);
